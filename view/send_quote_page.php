...
<div class="wrap">
    ...
    <h2><?php _e('Send Quote', 'quip-invoices'); ?></h2>
    <div id="updateDiv" class="error"><p><?php _e('This feature is only available in the premium version of Quip Invoices', 'quip-invoices'); ?></p></div>
